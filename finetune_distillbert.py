...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("finetune_distilbert_stratified.log"),
    ],
)
...
OUTPUT_DIR = "finetuned_distilbert_stratified"
...
def run_cv(texts, labels):
    ...
    logger.info("Starting %d-fold StratifiedKFold CV with %s", N_SPLITS, MODEL_NAME)
...
if __name__ == "__main__":
    logger.info("=" * 60)
    logger.info("finetune_distilbert_stratified.py started")
    ...
    run_cv(texts, labels)
    logger.info("finetune_distilbert_stratified.py finished")
